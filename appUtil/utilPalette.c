...
{
      RGB8Color *default_palette = malloc(sizeof(RGB8Color) * 5);
      default_palette[0] = (RGB8Color){0, 0, 0, 0};
      default_palette[1] = (RGB8Color){0xFF, 0, 0, 0};
      default_palette[2] = (RGB8Color){0, 0xFF, 0, 0};
      default_palette[3] = (RGB8Color){0, 0, 0xFF, 0};
      default_palette[4] = (RGB8Color){0xFF, 0xFF, 0xFF, 0};
      cp->cpColorCount= 5;
      cp->cpColors= default_palette;
}
