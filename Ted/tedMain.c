...
static AppMenuItem TED_AppFileMenuItems[]=
{
    ...
    "appFileMenuQuitKey",	"Ctrl <Key>q",
    "appFileMenuQuitKeyText",	"^Q",	ITEMtyOPTION, appAppFileQuit,
    },
};
...
#   define	TEDmiDocFileQuit		10
    ...
    "docFileMenuQuitKey",	"Ctrl <Key>q",
    "docFileMenuQuitKeyText",	"^Q",	ITEMtyOPTION, appDocFileQuit,
    },
};
